...
plt.fill_between(time_x, value_y_plot9, value_y_plot8,
                 ...
                 interpolate=True, color='orange', alpha=0.5, label='Lower Profits')
plt.fill_between(time_x, value_y_plot9, color='red', alpha=0.7, label='Losses('+str(round(value_y_plot3[period_num], 2))+'='+str(1-round(value_y_plot3[period_num], 2))+')')
plt.legend()
''
#plt.figure('P&L')
plt.subplot(1, 2, 2)
